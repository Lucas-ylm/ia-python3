...
def ollama_chat(user_input, system_message, vault_embeddings, vault_content, ollama_model, conversation_history):
    ...
    # SI RAG ACITVE ALORS ON RECUPERE LE CONTEXT PERTINENT
    if args.use_rag:
    ...
    relevant_context = get_relevant_context(rewritten_query, vault_embeddings, vault_content) if args.use_rag else []
    if relevant_context:
        context_str = "\n".join(relevant_context)
...
parser.add_argument("--use_rag", action="store_true", help="Use Retrieval-Augmented Generation (RAG) for responses")
